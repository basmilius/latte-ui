(function (global, factory) {
...
}(this, function (Vue$1, moment$1) { 'use strict';
	...
	function createElement(element, fn = undefined)
	{
	...
	Vue$1.filter("i18n", (value, domain = "root", ...params) => Latte.i18n.translate(domain, value, params));
	...
	function create(message, type, dismissible = true)
	{
		const noticeId = id();
	...
	var scripts = {
		...
		watch: "rollup -c --configDebug --watch.chokidar"
	};
	var repository = {
		type: "git",
	...
	var homepage = "https://github.com/basmilius/latte-ui#readme";
	var devDependencies = {
		"@babel/core": "^7.2.2",
	...
	function registerPointerEventsPolyfill()
	{
	...
	var script$9 = {
		...
		computed: {
			...
			inputValue()
			{
				return moment$1(this.current).format("YYYY-MM-DD");
			}
	...
	var script$a = {
		...
		computed: {
			...
			{
				return {
					1: moment$1().month(0).format("MMMM"),
					2: moment$1().month(1).format("MMMM"),
					3: moment$1().month(2).format("MMMM"),
					4: moment$1().month(3).format("MMMM"),
					5: moment$1().month(4).format("MMMM"),
					6: moment$1().month(5).format("MMMM"),
					7: moment$1().month(6).format("MMMM"),
					8: moment$1().month(7).format("MMMM"),
					9: moment$1().month(8).format("MMMM"),
					10: moment$1().month(9).format("MMMM"),
					11: moment$1().month(10).format("MMMM"),
					12: moment$1().month(11).format("MMMM")
				};
			},
	...
	var script$b = {
		...
		computed: {
			...
			inputValue()
			{
				return moment$1(this.current).format("YYYY-MM-DD[T]HH:mm");
			}
	            ...
	            ? _c(
	                ...
	                [
	                  _c(
	                    "button",
	                    {
	                      staticClass: "btn btn-icon btn-text btn-primary ml-3",
	                      attrs: { slot: "after" },
	                      on: { click: _vm.select },
	                      slot: "after"
	                    },
	        ...
	        return [
	          _c(
	            "div",
	            {
	              ...
	              class: _vm.getNotificationClasses(notification),
	              style: _vm.getNotificationStyles(notification)
	            },
	            [
	              notification.avatar
	                ? _c("img", {
	              ...
	              _c("div", { staticClass: "notification-content" }, [
	                ...
	                notification.actions
	                  ? _c(
	                      ...
	                      _vm._l(notification.actions, function(a) {
	                        return _c(
	                          "button",
	                          _vm._b(
	                            {
	                              staticClass: "btn btn-text",
	                              class: "btn-" + (a.type || "primary"),
	                              attrs: { "data-action": a.action },
	                              on: {
	                                click: function($event) {
	                            ...
	                            "button",
	                            _vm.makeParams(a.params || {}),
	                            false
	                          ),
	                          [_c("span", [_vm._v(_vm._s(a.label))])]
	                        )
	                      }),
	                      0
	                    )
	...
	__vue_render__$m._withStripped = true;
	  ...
	  var OffscreenContainer = normalizeComponent_1(
	...
	var __vue_render__$n = function() {
	  ...
	  return _vm.isVisible
	    ? _c(
	        "div",
	        {
	          staticClass: "latte-overlay",
	          class: { "is-visible": _vm.isVisible, "is-open": _vm.isOpen },
	          attrs: { role: "dialog" }
	        },
	        [_vm._t("default")],
	        2
	...
	var __vue_render__$o = function() {
	  ...
	  return _c(
	    "nav",
	    { staticClass: "pagination ml-auto", attrs: { role: "navigation" } },
	    [
	      _vm._l(_vm.pagination, function(entry) {
	        return [
	          _c(
	            "a",
	            {
	              ...
	              class: {
	                "is-current": entry.is_current,
	                "is-disabled": entry.is_disabled
	              },
	              attrs: { role: "menuitem" },
	              on: {
	                click: function($event) {
	                  return _vm.navigate(entry.page)
	                }
	              }
	            },
	            [
	              entry.is_dots
	                ? [_vm._v("…")]
	                : entry.label === "first"
	                ? [_c("i", { staticClass: "mdi mdi-chevron-double-left" })]
	                : entry.label === "prev"
	                ? [_c("i", { staticClass: "mdi mdi-chevron-left" })]
	                : entry.label === "next"
	                ? [_c("i", { staticClass: "mdi mdi-chevron-right" })]
	                : entry.label === "last"
	                ? [_c("i", { staticClass: "mdi mdi-chevron-double-right" })]
	  ...
	  return _vm.hasSupport
	    ? _c(
	        ...
	        [
	          ...
	          _c(
	            "nav",
	            { staticClass: "nav nav-list latte-context-menu" },
	            [
	              _c(
	                "a",
	                {
	                ...
	                [
	                  ...
	                  _c("span", [
	                    _vm._v(
	                      _vm._s(_vm._f("i18n")("Open in new tab", "pdf-viewer"))
	                    )
	                  ])
	                ]
	              ),
	              ...
	              _c(
	                "a",
	                { staticClass: "nav-link", on: { click: _vm.download } },
	                [
	                  _c("i", { staticClass: "mdi mdi-download" }),
	                  _vm._v(" "),
	                  _c("span", [
	                    _vm._v(_vm._s(_vm._f("i18n")("Download", "pdf-viewer")))
	                  ])
	                ]
	              ),
	              _vm._v(" "),
	              _c("a", { staticClass: "nav-link", on: { click: _vm.print } }, [
	                _c("i", { staticClass: "mdi mdi-printer" }),
	                _vm._v(" "),
	                _c("span", [
	                  _vm._v(_vm._s(_vm._f("i18n")("Print", "pdf-viewer")))
	                ])
	              ]),
	              _vm._v(" "),
	              _c("div", { staticClass: "divider divider-horizontal" }),
	              _vm._v(" "),
	              _c("a", { staticClass: "nav-link", on: { click: _vm.load } }, [
	                _c("i", { staticClass: "mdi mdi-reload" }),
	                _vm._v(" "),
	                _c("span", [
	                  _vm._v(_vm._s(_vm._f("i18n")("Reload", "pdf-viewer")))
	                ])
	              ]),
	              _vm._v(" "),
	              _vm._t("menu")
	...
	var script$t = {
		...
		computed: {
			...
			ownTransports()
			{
				...
				return this.multiple ? transports$$1 : (transports$$1.length === 0 ? [] : [transports$$1[transports$$1.length - 1]]);
			},
	...
	var script$E = {
		...
		computed: {
			...
			isAMPM()
			{
				return moment$1().localeData().longDateFormat("LT").endsWith("A");
			}
	...
	var __vue_render__$C = function() {
	  ...
	  return _c(
	    ...
	    _vm._l(_vm.children, function(child, key) {
	      return _c("latte-tree-view-item", {
	        key: key,
	        attrs: {
	          id: child.id,
	...
	var __vue_render__$D = function() {
	  ...
	  var _h = _vm.$createElement;
	  var _c = _vm._self._c || _h;
	  return _c("div", { staticClass: "tree-view-item" }, [
	    _c(
	      "div",
	      {
	        staticClass: "tree-view-item-label",
	        class: { "is-expanded": _vm.isExpanded },
	        on: {
	          click: function($event) {
	            return _vm.click(_vm.id)
	          }
	        }
	      },
	      [
	        _vm.children.length > 0
	          ? _c(
	              "button",
	              {
	                staticClass: "btn btn-text btn-icon btn-dark btn-sm",
	                on: { click: _vm.toggle }
	              },
	              [_c("i", { staticClass: "mdi mdi-chevron-right" })]
	            )
	        ...
	        _vm._v(" "),
	        _c("i", {
	          class: ["tree-view-item-label-icon", "mdi", "mdi-" + _vm.icon]
	        }),
	        _vm._v(" "),
	        _c("span", { staticClass: "tree-view-item-label-label" }, [
	          _vm._v(_vm._s(_vm.name))
	        ])
	      ]
	    ),
	    _vm._v(" "),
	    _vm.children.length > 0 && _vm.isExpanded
	      ? _c(
	          "div",
	          { staticClass: "tree-view-item-children" },
	          _vm._l(_vm.children, function(child, key) {
	            return _c("latte-tree-view-item", {
	              key: key,
	              attrs: {
	...
	__vue_render__$D._withStripped = true;
	  ...
	  var TreeViewItem = normalizeComponent_1(
	    { render: __vue_render__$D, staticRenderFns: __vue_staticRenderFns__$D },
	    __vue_inject_styles__$G,
	    __vue_script__$G,
	    __vue_scope_id__$G,
	...
	var MomentMixin = {
		...
		methods: {
			...
			moment(...args)
			{
				return moment$1(...args);
			},

			momentDuration(...args)
			{
				return moment$1.duration(...args);
			},

			momentUtc(...args)
			{
				return moment$1.utc(...args);
			}
	...
	var __vue_render__$H = function() {
	  ...
	  return _c(
	    "div",
	    {
	      staticClass: "panel widget",
	      class: { "is-custom-body": _vm.customBody },
	      attrs: { tabindex: "0" }
	    },
	    [
	      _c(
	        ...
	        [
	          _c("div", {
	            staticClass: "widget-drag-handle grid-item-drag-handle"
	          }),
	          _vm._v(" "),
	          _vm._t("custom_title"),
	          _vm._v(" "),
	          _c(
	            "div",
	            { staticClass: "ml-auto d-flex flex-row align-items-center" },
	            [
	              _vm._t("title"),
	              _vm._v(" "),
	              _c(
	                "latte-button-dropdown",
	                { attrs: { icon: "dots-vertical", small: true, type: "list" } },
	                [
	                  _c(
	                    "nav",
	                    { staticClass: "nav nav-list" },
	                    [
	                      ...
	                      _c(
	                        ...
	                        [
	                          _c("i", { staticClass: "mdi mdi-delete" }),
	                          _vm._v(" "),
	                          _c("span", [_vm._v(_vm._s(_vm._f("i18n")("Delete")))])
	                        ]
	                      )
	                    ],
	                    2
	...
	__vue_render__$H._withStripped = true;
	  ...
	  var Widget = normalizeComponent_1(
	    { render: __vue_render__$H, staticRenderFns: __vue_staticRenderFns__$H },
	    __vue_inject_styles__$M,
	    __vue_script__$M,
	    __vue_scope_id__$M,
	...
	var __vue_render__$I = function() {
	  ...
	  return _c(
	    ...
	    _vm._b(
	      {
	        staticClass: "widget-today",
	        attrs: { "custom-body": true },
	    ...
	    [
	      _c(
	        "div",
	        {
	          staticClass: "widget-today-datetime",
	          attrs: { slot: "content" },
	          slot: "content"
	        },
	        [
	          _c("div", { staticClass: "date" }, [
	            _c("span", { staticClass: "day text-capitalize" }, [
	            ...
	            _vm._v(" "),
	            _c("span", { staticClass: "monthyear text-capitalize" }, [
	              _vm._v(
	                _vm._s(_vm.currentMonth) +
	                  " " +
	                  _vm._s(_vm.currentYear) +
	                  " — Week " +
	                  _vm._s(_vm.currentWeekNumber)
	              )
	            ])
	          ]),
	          _vm._v(" "),
	          _c("div", { staticClass: "time" }, [
	            _c("span", { attrs: { id: "hours" } }, [
	              _vm._v(_vm._s(_vm.currentTimeHours))
	            ]),
	            _c("span", { staticClass: "dots" }, [_vm._v(":")]),
	            _c("span", { attrs: { id: "minutes" } }, [
	              _vm._v(_vm._s(_vm.currentTimeMinutes))
	            ]),
	            _c("span", { attrs: { id: "seconds" } }, [
	              _c("span", { staticClass: "dots" }, [_vm._v(":")]),
	              _vm._v(_vm._s(_vm.currentTimeSeconds))
	            ])
	          ])
	        ]
	      )
	...
	__vue_render__$I._withStripped = true;
	  ...
	  var WidgetToday = normalizeComponent_1(
	    { render: __vue_render__$I, staticRenderFns: __vue_staticRenderFns__$I },
	    __vue_inject_styles__$N,
	    __vue_script__$N,
	    __vue_scope_id__$N,
