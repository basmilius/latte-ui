...
<template>
	...
	<div class="page" id="component-chat">

		<PageHeader title="Chat" :tabs="tabs"/>
...
<script>
	...
	export default {
		...
		data()
		{
			return {
				previews: {
					standard: require("raw-loader!../../data/components/chat/standard.html").default,
					avatar: require("raw-loader!../../data/components/chat/avatar.html").default
				},
				tabs: [
