...
<template>
	...
	<div class="panel radius-none" style="height: calc(100vh - var(--appBarHeight))">
...
<script>
	...
	export default {
		...
		components: {Editor, SettingsPane},
	...
	const exampleContent = [
		...
		},
		{
			...
			"options": {
				"align": "right",
				"class": "",
				"color": "rgb(126, 123, 158)",
				"fontSize": 1.35,
				"indent": 10,
				"text": "<i>\"Aenean varius pretium tortor eu porttitor. Vivamus finibus sagittis tellus, sit amet porta tortor tempor ac. Aenean ac mauris lobortis ipsum feugiat volutpat nec sit amet ex.\"</i>"
			}
		},
		{
			"id": "button",
				...
				[
					...
					},
					{
						...
						"options": {
							...
							"fontSize": 1,
							"indent": 0,
							"text": "Phasellus commodo, lacus non viverra imperdiet, libero orci lacinia velit, sit amet malesuada dui diam eu lectus. Sed maximus eu orci ut condimentum.&nbsp;"
						}
					},
					{
						"id": "paragraph",
						"options": {
							...
							"fontSize": 1,
							"indent": 0,
							"text": "Vivamus auctor sapien nisl, varius interdum libero malesuada sit amet. Integer vulputate facilisis urna id sollicitudin."
						}
					}
				]
			]
